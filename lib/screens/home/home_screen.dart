            ...
            return Scaffold(
              body: ListView(
                children: [
                  ...
                  HorizontalSongList(
                      con: con, songs: state.songs.sublist(0, 1)),
                  const SizedBox(height: 12),
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 16.0, vertical: 8),
                  ...
                  HorizontalArtistList(
                      con: con, users: state.users.sublist(0, 1)),
                  const SizedBox(height: 12),
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 16.0, vertical: 8),
                  ...
                  HorizontalArtistList(
                      con: con, users: state.users.sublist(1)),
                  const SizedBox(height: 12),
                ],
              ),
            );
